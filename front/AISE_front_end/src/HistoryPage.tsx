...
function HistoryPage() {
    ...
    const handleAdd = (record: {id: number, date: string, method: string, category: string, description: string, amount: number, currency: string, type: boolean}) => {
    ...
    return (
        ...
        <div className="history-page-top">
            ...
            <select name="time-perion" id="history-page-select" value={timePeriod} onChange={handleTimePeriodChange}>
        ...
        <div className="history-page-list-container">
            <div className="history-page-list-top">
