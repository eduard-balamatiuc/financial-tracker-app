...
function CardAdd({addCard}: CardAddProps) {
    ...
    return (
        <form className="card card-add" onSubmit={handleSubmit}>
            <input type="text" placeholder="Bank" value={bankName} onChange={handleBankName}/>
            <div>
                <input type="text" placeholder="Balance" value={balance} onChange={handleBalance}/>
                <select name="currency" id="currency" defaultValue={"lei"} onChange={handleCurrency}>
            ...
            <div>
                <input type="text" placeholder="Last 4 digits" value={number} onChange={handleNumber}/>
                <select name="card-type" id="card-type-select" defaultValue={"mastercard"} onChange={handleType}>
