...
function Savings() {
    const [savingsData, setSavingsData] = useState(savings.map((element) => element.amount));
    ...
    return (
        <div className="statistics-page-element">
            <div className="statistics-page-top">
                <p>Savings</p>
                <select name="time-period" id="savings-select" defaultValue={timePeriod} onChange={handleTimePeriodChange}>
